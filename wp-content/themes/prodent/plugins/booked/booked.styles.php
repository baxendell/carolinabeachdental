...
if (!function_exists('prodent_booked_get_css')) {
	add_filter('prodent_filter_get_css', 'prodent_booked_get_css', 10, 4);
	function prodent_booked_get_css($css, $colors, $fonts, $scheme='') {
