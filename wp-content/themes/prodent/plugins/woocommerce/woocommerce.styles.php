...
if ( !function_exists( 'prodent_woocommerce_get_css' ) ) {
	add_filter( 'prodent_filter_get_css', 'prodent_woocommerce_get_css', 10, 4 );
	function prodent_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
/* Buttons */
.prodent_shop_mode_buttons a {
	color: {$colors['text_dark']};
}
.prodent_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
