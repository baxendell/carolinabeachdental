...
if (!function_exists('prodent_trx_addons_get_css')) {
	add_filter('prodent_filter_get_css', 'prodent_trx_addons_get_css', 10, 4);
	function prodent_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_price_item .sc_price_item_icon {
	color: {$colors['text_link']};
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_price_item:hover .sc_price_item_icon {
	color: {$colors['text_hover']};
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_price_item .sc_price_item_label {
	background-color: {$colors['text_link']};
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_price_item:hover .sc_price_item_label {
	background-color: {$colors['text_hover']};
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_price_item:hover .sc_price_item_title,
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_price_item .sc_price_item_title {
	background-color: {$colors['text_link']};	
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_price_item .sc_price_item_price {
	background-color: {$colors['text_link']};
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_price_item .sc_price_item_icon {
	color: {$colors['text_link']};
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_price_item .sc_button.sc_button_simple,
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_button_simple:not(.sc_button_bg_image):before,
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_button_simple:not(.sc_button_bg_image):after {
    color: {$colors['text_link']};
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_price_item .sc_button.sc_button_simple:hover,
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_button_simple:not(.sc_button_bg_image):hover:before,
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n+2) .sc_button_simple:not(.sc_button_bg_image):hover:after {
    color: {$colors['text_link2']}!important;
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n) .sc_price_item:hover .sc_price_item_icon {
	color: {$colors['text_hover3']};
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n) .sc_price_item .sc_price_item_label {
	background-color: {$colors['text_link3']};
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n) .sc_price_item:hover .sc_price_item_label {
	background-color: {$colors['text_hover3']};
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n) .sc_price_item:hover .sc_price_item_title,
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n) .sc_price_item .sc_price_item_title {
	background-color: {$colors['text_link3']};	
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n) .sc_price_item .sc_price_item_price {
	background-color: {$colors['text_link3']};
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n) .sc_price_item .sc_button.sc_button_simple,
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n) .sc_button_simple:not(.sc_button_bg_image):before,
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(3n) .sc_button_simple:not(.sc_button_bg_image):after {
    color: {$colors['text_link3']};
}
...
.sc_services_callouts .sc_services_item .sc_services_item_info {
	background-color:{$colors['bg_color']};
}
...
.vc_row-has-fill .sc_testimonials [class*="column"] .sc_testimonials_item_content {
	background-color: {$colors['bg_color']};
}
.scheme_dark .sc_testimonials [class*="column"] .sc_testimonials_item_content {
	background-color: {$colors['alter_bd_hover_06']};
}
.sc_testimonials.color_style_dark .sc_item_title,
.sc_testimonials.color_style_dark .sc_item_subtitle {
	color: {$colors['bg_color']};
}
...
.sc_action_item.sc_action_item_default.sc_action_item_ml .sc_action_item_link:hover {
...
.sc_action_item.sc_action_item_simple.sc_action_item_mc .sc_action_item_link {
	color: {$colors['text_dark']};
}
.sc_action_item.sc_action_item_simple.sc_action_item_mc .sc_action_item_link:hover {
	color: {$colors['text_dark']}!important;
}
.sc_services_callouts .sc_button.sc_button_simple {
	color: {$colors['text']};
}
.sc_services_callouts .sc_button.sc_button_simple:hover {
	color: {$colors['text_link']};
}

.sc_content .widget.widget_slider .sc_slider_controls .slider_controls_wrap > a,
.sc_content .widget.widget_slider .slider_container.slider_controls_side .slider_controls_wrap > a,
.sc_content .widget.widget_slider .slider_outer_controls_side .slider_controls_wrap > a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_link']};
	border-color: {$colors['text_link']};
}
.sc_content .widget.widget_slider .sc_slider_controls .slider_controls_wrap > a:hover,
.sc_content .widget.widget_slider .slider_container.slider_controls_side .slider_controls_wrap > a:hover,
.sc_content .widget.widget_slider .slider_outer_controls_side .slider_controls_wrap > a:hover {
	color: {$colors['text_link']};
	background-color: {$colors['bg_color_0']};
	border-color: {$colors['text_link']};
}
.swiper-slide .sc_item_title {
	color: {$colors['text_link']};
}
...
.trx_addons_list_parameters > li:nth-child(2n+1) {
	background-color: {$colors['alter_bd_hover_04']};
}
